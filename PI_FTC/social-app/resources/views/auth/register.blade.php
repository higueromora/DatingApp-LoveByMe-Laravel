                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="residencia" type="text" class="form-control @error('residencia') is-invalid @enderror" name="residencia" value="{{ old('residencia') }}" autocomplete="residencia" autofocus>
