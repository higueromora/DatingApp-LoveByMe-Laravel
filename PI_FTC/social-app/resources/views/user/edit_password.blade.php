...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">Configuración de mi contraseña</div>
...
<form method="POST" action="{{ route('user.delete') }}" onsubmit="return confirm('¿Estás seguro de que quieres borrar tu perfil? Esta acción no se puede deshacer.')">
    @csrf
